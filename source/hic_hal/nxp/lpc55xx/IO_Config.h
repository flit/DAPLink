...
// SWDIO I/O Pin                PIO0_2
// (DBGIF_TMS_SWDIO)
#define PIN_SWDIO_OUT_BIT       (2)

// SWDIO Output Enable Pin      PIO0_28
// (DBGIF_TMS_SWDIO_TXEN)
#define PIN_SWDIO_OE_BIT        (28)

// TDI Output Pin               PIO0_1
// (DBGIF_TDI)
#define PIN_TDI_BIT             (1)

// TDO/SWO Input Pin            PIO0_3
// (DBGIF_TDO_SWO)
