/**
 * @file    flash_blob.c
 * @brief   Flash algorithm for the kw35z
 *
...
static const uint32_t mkw35z4_flash_prog_blob[] = {
...
static const program_target_t flash = {
    ...
    sizeof(mkw35z4_flash_prog_blob), // prog_blob size
    mkw35z4_flash_prog_blob,         // address of prog_blob
